/**
 * @file gpiolib.h
 * @brief Basic Arduino-compatible functions for general-purpose input/output
 *
 * Assumes GPIO0_BASE is set to the memory-mapped GPIO address.
 *
...
static inline void pinMode(int pin, int function)
{
    switch(function) {
        case INPUT:
