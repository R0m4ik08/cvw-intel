...
set_module_property NAME sdram_128mb
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME sdram_128mb
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL SDRAM_128MB
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file SDRAM_128MB.v VERILOG PATH src/sdram_128mb.v TOP_LEVEL_FILE
...
add_interface_port s1 az_be_n writebyteenable_n Input 4
add_interface_port s1 az_cs chipselect Input 1
add_interface_port s1 az_data writedata Input 32
add_interface_port s1 az_rd_n read_n Input 1
add_interface_port s1 za_data readdata Output 32
...
add_interface_port wire zs_dq dq Bidir 32
add_interface_port wire zs_dqm dqm Output 4
